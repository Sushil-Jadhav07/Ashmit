  ...
  return (
    <>
      <Layout
        headerStyle={4}
        footerStyle={3}
        breadcrumbTitle="Corporate Services"
      >
                  ...
                  {/* <div className="services-details__contact">
                    ...
                    <ul className="services-details__contact-list list-unstyled">
                      <li>
                        ...
                        <p>Office no 40, 1st floor, Asiatic Arcade, <br/>Vartak Nagar, Thane (W) 400606</p>
                      </li>
                      <li>
                        <div className="icon">
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  ...
                  <ul className="services-details__points list-unstyled">
                    <li>
                      <p>1. Incorporation of Company Formation of LLP</p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>5. Maintenance of Statutory Records.</p>
                    </li>
                    <li>
                      <p>6. Change of Names, Objects, Registered Office, etc</p>
                    </li>
                  </ul>
