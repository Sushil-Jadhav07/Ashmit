              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  ...
                  <p className="services-details__text-1">
                    We provide various to generate a budget and financial
                    projections to give you and your board the best financial
                    information possible to make strategic decisions about your
                    company's future as well as the toolset to hold your team
                    accountable for hitting your goals. Such As:
                  </p>
