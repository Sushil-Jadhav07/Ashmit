              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  ...
                  <ul className="services-details__points list-unstyled">
                    ...
                    <li>
                      <p>6. Cloud based accounting services</p>
                    </li>
                    <li>
                      <p>7. Setting up Costing system</p>
                    </li>
                    <li>
                      <p>8. Setting up Inventory system</p>
                    </li>
                    <li>
                      <p>9. Budgeting</p>
                    </li>
                    <li>
                      <p>10. Financial Reporting</p>
                    </li>
                    <li>
                      <p>11. MIS Reports</p>
                    </li>
                    ...
                    <li>
                      <p>13. Asset Accounting Management</p>
                    </li>
                    <li>
                      <p>14. Depreciation and Amortization Schedules</p>
                    </li>
                  </ul>
                      ...
                      <div className="col-xl-3">
                        <div className="process-four__single">
                          <div className="process-four__shape-1">
                            <img
                              src="assets/images/shapes/process-four-shape-1.png"
                              alt=""
                            />
                          </div>
                          <div className="process-four__count"></div>
                          <h3 className="process-four__title">
                            Identifying Problems
                          </h3>
                          <p className="process-four__text">
                    ...
                    >
                      ...
                      >
                        <div className="accrodion-title">
                          <h4>
                            <span>Q1.</span>What activities are done in the
                            development?
                          </h4>
                        </div>
                        <div className="accrodion-content">
                          <div className="inner">
                            <p>
                              Follow these 6 steps and you’ll get your Help
                              Scout account up and running in no time. If you'd
                              like to get a full tour of Help Scout and all its
                              features, attend one of our weekly live demos or
                              take a video tour.
                            </p>
                          </div>
                        </div>
                      ...
                      >
                        <div className="accrodion-title">
                          <h4>
                            <span>Q2.</span>How can i use landbook When should I
                            use a Tag?
                          </h4>
                        </div>
                        <div className="accrodion-content">
                      ...
                      >
                        <div className="accrodion-title">
                          <h4>
                            <span>Q3.</span>Are social media good for the
                            business growth?
                          </h4>
                        </div>
                        <div className="accrodion-content">
                      ...
                      >
                        <div className="accrodion-title">
                          <h4>
                            <span>Q4.</span>How often should i work on the
                            digital marketing?
                          </h4>
                        </div>
                        <div className="accrodion-content">
                      ...
                      >
                        <div className="accrodion-title">
                          <h4>
                            <span>Q5.</span>What are the different types of
                            marketing solutions?
                          </h4>
                        </div>
                        <div className="accrodion-content">
