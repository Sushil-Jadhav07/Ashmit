  ...
  return (
    <>
      <Layout
        headerStyle={4}
        footerStyle={3}
        breadcrumbTitle="Goods & Service Tax"
      >
                  ...
                  <div className="services-details__services-box">
                    <ul className="services-details__services-list list-unstyled">
                      ...
                      <li>
                        ...
                        Services for Non-resident<span className="icon-right-arrow1"></span>
                        </Link>
                      </li>
                      <li>
                        <Link href="other-services">
                        Other Services<span className="icon-right-arrow1"></span>
                        </Link>
                      </li>
                      <li>
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  ...
                  <p className="services-details__text-1">
                    GST implemented from July 2017 across India. We advise many
                    companies for GST related compliances such as:
                  </p>
