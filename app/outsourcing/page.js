...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={4} footerStyle={3} breadcrumbTitle="Outsourcing">
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  <div className="services-details__img">
                    <img src="assets/images/services/Outsourcing.png" alt="" />
                  </div>
                  <h3 className="services-details__title-1">Outsourcing</h3>
                  <p className="services-details__text-1">
                    Outsourcing help companies to focus on their core activities
                    and also achieve high level of compliances.
                  </p>
                  <ul className="services-details__points list-unstyled pt-3">
                    <li>
                      <p>
                        1. Enables business to concentrate on core business
                        activities.
                      </p>
                    </li>
                    <li>
                      <p>2. Use of manpower for more important functions</p>
                    </li>
                    <li>
                      <p>3. Investment in fixed assets reduced/minimized.</p>
                    </li>
                    <li>
                      <p>4. Substantial Savings in Cost.</p>
                    </li>
                    <li>
                      <p>5. Services of experts made available.</p>
                    </li>
                    <li>
                      <p>6. Improved Internal Controls</p>
                    </li>
                    <li>
                      <p>
                        7. Enhanced reporting capabilities to provide more
                        timely and accurate financial data
                      </p>
                    </li>
                    <li>
                      <p>8. Off-site Backup of Data.</p>
                    </li>
                  </ul>
