...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={4} footerStyle={3} breadcrumbTitle="TDS">
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="services-details__right">
                  <div className="services-details__img">
                    <img src="assets/images/services/TDS.png" alt="" />
                  </div>
                  <h3 className="services-details__title-1">TDS</h3>
                  <p className="services-details__text-1">
                    TDS was introduced with an aim to collect tax from the very
                    source of income. As per this concept, a person (deductor)
                    who is liable to make payment of specified nature to any
                    other person (deductee) shall deduct tax at source and remit
                  ...
                  <ul className="services-details__points list-unstyled pt-3">
                    ...
                    <li>
                      <p>2. Filing of TDS Returns</p>
                    </li>
                    <li>
                      <p>3. Issue of TDS certificates</p>
                    </li>
                    <li>
                      <p>4. Resolving issues in TDS returns</p>
                    </li>
                  </ul>
